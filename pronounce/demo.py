...
import pickle
"""
s = train_translator.get_weights()
try:
    with open('t.pkl', 'wb') as f:
        pickle.dump(s, f, protocol=pickle.HIGHEST_PROTOCOL)
except Exception as e:
    with open('t.pkl', 'w') as f:
        pickle.dump(s, f, protocol=pickle.HIGHEST_PROTOCOL)
"""
with open('t.pkl','rb') as f:
    train_translator.set_weights(pickle.load(f))
...
input_text = tf.constant([
    'これはテストです。', # "It's really cold here."
    '蝉時雨は千年先もああ。', # "This is my life.""
])
